...
{
    class suydientien //Forward chaining
    {
        #region Khai bao
        ...
        public void DocLuatTuFfile() //Read Rule
        {
        ...
        public string XuatLuat(List<RuleDefine> mangLuat) //print rule
        {
            string tg = "";
        ...
        public bool CheckIn(List<string> a,List<string> b) //check rule
        {
            int dem = 0;
        ...
        public void TimTapSat(List<string> L,List<RuleDefine> mangLuat) //find the rule book
        {
        ...
        public bool SuyDien(List<string> left, List<string> right)  //deduction
        {
            ...
            {
                //lay luat r cuoi cung ra ap dung (Get the last rule to apply)
                RuleDefine r = SAT.ElementAt(0);
                mangLuat.Remove(r);
                SAT.RemoveAt(0);
                //them cai chua co vao TG (Add not have to TG)
